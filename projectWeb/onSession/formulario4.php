  ...
  <div class="col s12 l8 m12">
    <div style="border-radius: 20px;" class="card black">
      ...
      <div style="border-radius: 20px;" class="card-action">
        <div class="row">
          <form class="col l12 s12 m12 white-text" id="form4">
            <div class="input-field col s12 l12 m12">
              <textarea id="LogrosPer" name="LogrosPer" class="materialize-textarea white-text" data-length="600" maxlength="600" required></textarea>
